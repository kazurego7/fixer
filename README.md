...
![リポジトリ選択画面のスクリーンショット（後で差し替え）](docs/images/placeholder-repos.png)

GitHub リポジトリを選んで、そのまま作業を始められます。

![チャット画面のスクリーンショット（後で差し替え）](docs/images/placeholder-chat.png)

スマホから Codex に指示を出し、返答をその場で確認できます。

![変更確認画面のスクリーンショット（後で差し替え）](docs/images/placeholder-files.png)

変更ファイルや `diff` を見て、結果をすぐ確認できます。
